...
const FEED_TIMELINE_AUTH = `query Publications($request: PublicationsQueryRequest! $profileId: ProfileId) {
  publications(request: $request) {
    items {
      __typename 
      ... on Post {
...
`;
export const feedTimelineAuth = (request: any, profileId: any) => {
  return apolloClient.query({
    query: gql(FEED_TIMELINE_AUTH),
    variables: {
      request,
      profileId,
    },
